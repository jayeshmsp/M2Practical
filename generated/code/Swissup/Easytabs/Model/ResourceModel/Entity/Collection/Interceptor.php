<?php
namespace Swissup\Easytabs\Model\ResourceModel\Entity\Collection;

/**
 * Interceptor class for @see \Swissup\Easytabs\Model\ResourceModel\Entity\Collection
 */
class Interceptor extends \Swissup\Easytabs\Model\ResourceModel\Entity\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addProductTabFilter');
        return $pluginInfo ? $this->___callPlugins('addProductTabFilter', func_get_args(), $pluginInfo) : parent::addProductTabFilter();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addWidgetTabFilter');
        return $pluginInfo ? $this->___callPlugins('addWidgetTabFilter', func_get_args(), $pluginInfo) : parent::addWidgetTabFilter();
    }
