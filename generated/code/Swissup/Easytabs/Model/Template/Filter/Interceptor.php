<?php
namespace Swissup\Easytabs\Model\Template\Filter;

/**
 * Interceptor class for @see \Swissup\Easytabs\Model\Template\Filter
 */
class Interceptor extends \Swissup\Easytabs\Model\Template\Filter implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'evalDirective');
        return $pluginInfo ? $this->___callPlugins('evalDirective', func_get_args(), $pluginInfo) : parent::evalDirective($construction);
    }
